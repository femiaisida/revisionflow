...
export async function generateStudyPlan(userData) {
  const { subjects, examDates, availableHours, preferences, weeksUntilFirst, firstExamDate, lastExamDate } = userData
...
One concrete, actionable technique tailored to the nature of this content. Explain why this works for this topic.
